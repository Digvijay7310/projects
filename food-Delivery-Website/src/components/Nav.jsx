...
function Nav() {
  return (
    <div className='w-full max-w-screen px-4 sm:px-6 md:px-8 h-[80px] sm:h-[90px] md:h-[100px] flex items-center justify-between gap-4 bg-transparent'>
      ...
      {/* Search Bar */}
      <form className='flex-1 mx-2 h-[45px] sm:h-[50px] md:h-[60px] bg-white flex items-center px-4 gap-2 rounded-2xl shadow-md'>
      ...
      {/* Cart Icon */}
      <div className='w-[40px] h-[40px] sm:w-[60px] sm:h-[60px] p-1 bg-white flex justify-center items-center rounded-md shadow-xl relative'>
        <span className="absolute -top-1 -right-1 text-black font-bold text-xs sm:text-sm bg-white px-1 rounded-full shadow">0</span>
