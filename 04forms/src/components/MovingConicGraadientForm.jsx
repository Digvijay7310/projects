...
const MovingConicGradientForm = () => {
  ...
  return (
    <div
      ...
      style={{
        background: "conic-gradient(#ff7e5f, #feb47b, #86a8e7, #91eae4, #ff7e5f)",
        backgroundSize: "300% 300%",
        animation: "moveColors 8s linear infinite",
      }}
    >
      <style>
        {`
...
export default MovingConicGradientForm;
